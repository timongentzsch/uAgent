...
`self-improve` runs one measured improvement iteration against the constitution
in its body: real-session evidence first, Pareto-constrained proposals, a slop
scan, and committed baselines as the gate. It is the entry point for "run
another iteration".
